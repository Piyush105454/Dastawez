  ...
  return (
    <body className="bg-gray-50 text-gray-800 font-sans">
      ...
      <section id="services" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 section-title">Our Services</h2>
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">Comprehensive solutions for all your document and digital needs</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* MP Online Services Card */}
            <div className="bg-white rounded-xl overflow-hidden shadow-md service-card border border-gray-100">
              <div className="h-48 bg-gray-100 flex items-center justify-center overflow-hidden">
                <img src="./img/mp online.jpeg" alt="Government Services" className="w-full h-full object-cover" />
              </div>
              <div className="p-6">
                ...
                <Link
                  ...
                  className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-300"
                >
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md service-card border border-gray-100">
              <div className="h-48 bg-gray-100 flex items-center justify-center overflow-hidden">
                <img src="img/Shanghai JiaoTong University illustration.jpeg" alt="Academic Forms" className="w-full h-full object-cover" />
              </div>
              <div className="p-6">
                <div className="flex items-center mb-3">
                  <div className="bg-blue-100 p-2 rounded-lg mr-3">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md service-card border border-gray-100">
              <div className="h-48 bg-gray-100 flex items-center justify-center overflow-hidden">
                <img src="./img/Credentialing & Contracting Services - MedConverge.jpeg" alt="Document Services" className="w-full h-full object-cover" />
              </div>
              <div className="p-6">
                <div className="flex items-center mb-3">
                  <div className="bg-blue-100 p-2 rounded-lg mr-3">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md service-card border border-gray-100">
              <div className="h-48 bg-gray-100 flex items-center justify-center overflow-hidden">
                <img src="img/digital service.jpeg" alt="Digital Services" className="w-full h-full object-cover" />
              </div>
              <div className="p-6">
                <div className="flex items-center mb-3">
                  <div className="bg-blue-100 p-2 rounded-lg mr-3">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md service-card border border-gray-100">
              <div className="h-48 bg-gray-100 flex items-center justify-center overflow-hidden">
                <img
                  src="./img/analytics and monitoring concept, business team on web reporting dashboard monitoring, and data analysis research for business financial planning_ flat vector illustration design on white background_.jpeg"
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md service-card border border-gray-100">
              <div className="h-48 bg-gray-100 flex items-center justify-center overflow-hidden">
                <img src="img/Exam forms.jpg" alt="Exam Forms" className="w-full h-full object-cover" />
              </div>
              <div className="p-6">
                <div className="flex items-center mb-3">
                  <div className="bg-blue-100 p-2 rounded-lg mr-3">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 section-title">How It Works</h2>
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">Simple steps to get your documents ready without leaving your home</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm text-center">
              ...
              <p className="text-gray-600">Fill our simple form with your requirements or upload your documents</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm text-center">
              ...
              <p className="text-gray-600">Our experts handle all the paperwork, printing, and processing</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm text-center">
              ...
              <p className="text-gray-600">Get your documents delivered to your doorstep or via email</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 section-title">Contact Us</h2>
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">Have questions or need assistance? We're here to help!</p>
          </div>

          <div className="flex flex-wrap justify-center gap-6 mb-12">
            {/* WhatsApp Card */}
            <div className="bg-blue-50 rounded-xl p-6 text-center min-w-[200px] flex-1 contact-card">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 section-title">Frequently Asked Questions</h2>
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">Find answers to common questions about our services</p>
          </div>

          <div className="max-w-3xl mx-auto space-y-4">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <button className="faq-button flex justify-between items-center w-full text-left font-semibold text-gray-800 focus:outline-none">
              ...
              <div className="mt-3 text-gray-600" style={{ maxHeight: '' }}>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">Let us handle the paperwork while you focus on what matters most</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="./order.html"
              className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold px-6 py-3 rounded-lg transition duration-300 transform hover:scale-105"
